% Algoritmo IP (Importance Partitioning IP)
% Proposto por G. Kokolakis, D. Fouskakis (2009)
% do artigo “Importance partitioning in micro-aggregation"
...
% Construir o primeiro grupo encontrando, inicialmente, o ponto mais próximo de xr, e, 
% em seguida, introduzir cada vez que um novo que está mais perto
% para a média dos pontos já seleccionados, até que um grupo de pontos k é formada.
function classes = ip(x,g)
